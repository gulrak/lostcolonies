...
/*
std::shared_ptr<Fl_Image> ResourceManager::getImage(const std::string& name) const
{
    Resource res = resourceForName(name);
    return std::make_shared<Fl_PNG_Image>(nullptr, res.data(), res.size());
}
*/
