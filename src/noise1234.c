...
float grad2( int hash, float x, float y ) {
    ...
    return ((h&1)? -u : u) + (float)((h&2)? -2.0*v : 2.0*v);
}
...
float noise1( float x )
{
    ...
    fx0 = x - (float)ix0; // Fractional part of x
    fx1 = fx0 - 1.0f;
    ix1 = ( ix0+1 ) & 0xff;
...
float noise2( float x, float y )
{
    ...
    fx0 = x - (float)ix0; // Fractional part of x
    fy0 = y - (float)iy0; // Fractional part of y
    fx1 = fx0 - 1.0f;
    fy1 = fy0 - 1.0f;
...
float noise3( float x, float y, float z )
{
    ...
    fx0 = x - (float)ix0; // Fractional part of x
    fy0 = y - (float)iy0; // Fractional part of y
    fz0 = z - (float)iz0; // Fractional part of z
    fx1 = fx0 - 1.0f;
    fy1 = fy0 - 1.0f;
    fz1 = fz0 - 1.0f;
    ix1 = ( ix0 + 1 ) & 0xff; // Wrap to 0..255
...
float noise4( float x, float y, float z, float w )
{
    ...
    fy0 = y - (float)iy0; // Fractional part of y
    fz0 = z - (float)iz0; // Fractional part of z
    fw0 = w - (float)iw0; // Fractional part of w
    fx1 = fx0 - 1.0f;
    fy1 = fy0 - 1.0f;
    fz1 = fz0 - 1.0f;
    fw1 = fw0 - 1.0f;
